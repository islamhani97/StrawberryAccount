package com.islam.strawberryaccount.ui.fragments.about;
...
public class AboutFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.fragmentAboutPhoneNumber.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.fragmentAboutMail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
